...
void initExtensions(Display *display, int screen){
	...
	if (GL_ATI_envmap_bumpmap_supported = isExtensionSupported("GL_ATI_envmap_bumpmap")){
...
// Workaround for a driver bug in current ATi Linux drivers
	...
	GL_EXT_separate_specular_color_supported = isExtensionSupported("GL_EXT_separate_specular_color"); 
